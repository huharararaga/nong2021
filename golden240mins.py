...
if any:
    def goldencross(symbol):
        ...
        if call=='골든크로스' or call=='데드크로스':       
            ...
            text=symbol+'\n'+'20이평선: '+ str(round(ma20.iloc[-1],2))+'\n'+'60이평선: '+ str(round(ma60.iloc[-1],2))+'\n'+call
            chat_id='텔레그램 챗아이디'
            bot = telegram.Bot(token='5043888178:AAEkJ6NPtqg8nBjgZgxrTXAAxwZKa3dlWq8')
            bot.sendMessage(chat_id=1576502417, text=text)              
            time.sleep(1)
    
         ## https://api.telegram.org/bot5043888178:AAEkJ6NPtqg8nBjgZgxrTXAAxwZKa3dlWq8/getme
